...
async def main():
    ...
    out_path = '/Users/sky/vehicle_damage_assessment/vehicle_damage_assessment/stability_reports/team_run_3.json'
    ...
    sum_path = '/Users/sky/vehicle_damage_assessment/vehicle_damage_assessment/stability_reports/team_run_3_summary.json'
    with open(sum_path, 'w', encoding='utf-8') as f:
        json.dump(summary, f, ensure_ascii=False, indent=2)

    print(f"Run 3 done: elapsed={elapsed:.1f}s, covered_views={covered_views}, subagent_count={subagent_count}, uncertain={len(uncertain_parts)}/25")
