...
PARTS_TOPOLOGY = {
    ...
    "visibility": {
        ...
        "bumper_front": ["front", "front_left_45", "front_right_45"],
        "headlight_front_left": ["front", "front_left_45", "left_90"],
        "headlight_front_right": ["front", "front_right_45", "right_90"],
        "grille_front": ["front", "front_left_45", "front_right_45"],
        "fender_front_left": ["front", "front_left_45", "left_90"],
        "fender_front_right": ["front", "front_right_45", "right_90"],
        "windshield_front": ["front", "front_left_45", "front_right_45", "top"],
        # ---- rear ----
        "trunk_lid": ["rear", "rear_left_45", "rear_right_45"],
        "tailgate": ["rear", "rear_left_45", "rear_right_45"],
        "bumper_rear": ["rear", "rear_left_45", "rear_right_45"],
        "taillight_rear_left": ["rear", "rear_left_45", "left_90"],
        "taillight_rear_right": ["rear", "rear_right_45", "right_90"],
        "windshield_rear": ["rear", "rear_left_45", "rear_right_45", "top"],
        # ---- left ----
        "door_front_left": ["left_90", "front_left_45", "rear_left_45"],
        "door_rear_left": ["left_90", "front_left_45", "rear_left_45"],
        "mirror_left": ["left_90", "front_left_45"],
        "fender_rear_left": ["left_90", "rear_left_45"],
        "pillar_a_left": ["left_90", "front_left_45", "top"],
        "pillar_b_left": ["left_90", "front_left_45", "rear_left_45", "top"],
        "pillar_c_left": ["left_90", "rear_left_45", "top"],
        # ---- right ----
        "door_front_right": ["right_90", "front_right_45", "rear_right_45"],
        "door_rear_right": ["right_90", "front_right_45", "rear_right_45"],
        "mirror_right": ["right_90", "front_right_45"],
        "fender_rear_right": ["right_90", "rear_right_45"],
        "pillar_a_right": ["right_90", "front_right_45", "top"],
        "pillar_b_right": ["right_90", "front_right_45", "rear_right_45", "top"],
        "pillar_c_right": ["right_90", "rear_right_45", "top"],
        # ---- roof ----
        "roof_front": ["front", "front_left_45", "front_right_45", "top"],
        "roof_middle": ["left_90", "right_90", "top"],
        "roof_rear": ["rear", "rear_left_45", "rear_right_45", "top"],
        "sunroof_glass": ["front", "front_left_45", "front_right_45", "left_90", "right_90", "top"],
        "roof_rack": ["front", "rear", "left_90", "right_90", "top"],
    },
}
