...
# Topology configuration for all 25 parts in PARTS_CATALOG.
...
PARTS_TOPOLOGY = {
    "adjacency": {
        ...
        # ---- left ----
        "door_front_left": ["fender_front_left", "door_rear_left", "mirror_left"],
        "door_rear_left": ["door_front_left", "fender_rear_left"],
        "mirror_left": ["fender_front_left", "door_front_left"],
        "fender_rear_left": ["door_rear_left", "bumper_rear", "taillight_rear_left"],
        # ---- right ----
        "door_front_right": ["fender_front_right", "door_rear_right", "mirror_right"],
        "door_rear_right": ["door_front_right", "fender_rear_right"],
        "mirror_right": ["fender_front_right", "door_front_right"],
        "fender_rear_right": ["door_rear_right", "bumper_rear", "taillight_rear_right"],
        # ---- roof ----
        "roof_front": ["windshield_front", "roof_middle", "sunroof_glass"],
        "roof_middle": ["roof_front", "roof_rear", "sunroof_glass", "roof_rack"],
        "roof_rear": ["roof_middle", "windshield_rear", "trunk_lid", "tailgate"],
    ...
    "visibility": {
        ...
        "windshield_front": ["front", "front_left", "front_right"],
        # ---- rear ----
        ...
        "windshield_rear": ["rear", "rear_left", "rear_right"],
        # ---- left ----
        ...
        # ---- roof ----
        "roof_front": ["front", "front_left", "front_right"],
        "roof_middle": ["left", "right"],
        "roof_rear": ["rear", "rear_left", "rear_right"],
        "sunroof_glass": ["front", "front_left", "front_right", "left", "right"],
        "roof_rack": ["front", "rear", "left", "right"],
    },
}
