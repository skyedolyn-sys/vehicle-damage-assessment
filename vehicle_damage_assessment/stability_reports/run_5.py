...
async def main():
    ...
    # Convert to serializable before JSON dump
    serializable_result = convert_to_serializable(result)

    out_path = '/Users/sky/vehicle_damage_assessment/vehicle_damage_assessment/stability_reports/team_run_5.json'
    with open(out_path, 'w', encoding='utf-8') as f:
        json.dump(serializable_result, f, ensure_ascii=False, indent=2)

    plan = serializable_result.get('plan', {})
    ...
    subagent_count = len(serializable_result.get('subagent_results', []))
    parts = serializable_result.get('parts', [])
    ...
    sum_path = '/Users/sky/vehicle_damage_assessment/vehicle_damage_assessment/stability_reports/team_run_5_summary.json'
    with open(sum_path, 'w', encoding='utf-8') as f:
        json.dump(summary, f, ensure_ascii=False, indent=2)

    print(f"Run 5 done: elapsed={elapsed:.1f}s, covered_views={covered_views}, subagent_count={subagent_count}, uncertain={len(uncertain_parts)}/25")
